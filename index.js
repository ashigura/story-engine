...
app.use((req, res, next) => {
  ...
  if (req.path === "/health" || req.path.startsWith("/admin-ui") || req.path === "/ws" || req.path === "/restream/login" || req.path === "/oauth/restream/callback" || req.path === "/bridge/status" || req.path === "/restream" ||  req.path === "/ingest/message") return next();
