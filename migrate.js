...
`);
     ...
     // --- NEU: chat_event (für Casterlabs/MultiChat Ingest) ---
  await pool.query(`
  ...
  await pool.query(`
    CREATE INDEX IF NOT EXISTS ix_chat_event_session_created
      ON chat_event(session_id, created_at DESC);
  `);

  await pool.query(`
    CREATE INDEX IF NOT EXISTS ix_chat_event_processed
